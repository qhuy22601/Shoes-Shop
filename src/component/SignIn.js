    ...
    <Container fluid className={styles.container}>
      ...
      >
        ...
        <form  onSubmit={handleSubmit}>
          <input type="text" name="sdt" placeholder="SDT" onChange={handlePhone} value={phoneNumber}></input><br/>
          <input type="password" name="password" placeholder="password" onChange={handlePass} value={password}></input>
          <button type="submit" name="btn" >signin</button>
        </form>
